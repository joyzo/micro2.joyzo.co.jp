...
// メイン処理
async function removeBasicAuth() {
  try {
    console.log('🔓 Basic認証の解除を開始します...');
    ...
    console.log('');
    console.log('🔓 Basic認証が解除されました。');
    
  } catch (error) {
    console.error('❌ Basic認証解除エラー:', error.message);
    if (error.code) {
